      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {partners.map((partner, index) => (
            <div
              key={partner.name}
              className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-gray-800/80 transition-all duration-300 transform hover:-translate-y-1 group border border-gray-700/50 hover:border-white/20"
            >
