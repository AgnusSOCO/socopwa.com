          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-white">AI-Powered Future</h3>
                <p className="text-blue-200/80">Revolutionizing industries with next-gen AI solutions</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-blue-200/80">Creating tomorrow's solutions today</p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-white">Digital Evolution</h3>
                <p className="text-blue-200/80">Transforming businesses for the digital age</p>
              </div>
            </motion.div>
          </div>
        </div>
