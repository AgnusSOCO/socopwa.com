...
import { Shield, Zap, Gamepad2, Award, BookOpen, Users, Code, Server, Database, Lock, FileCheck, Layers, Cpu, Network, BarChart, CheckCircle, Briefcase, Cloud } from 'lucide-react';
